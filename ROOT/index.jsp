...
<html>
	<head>
      ...
      text-align: center;
			...
			#contentform form > div.required :lang(en)
			{
			color: #fff;
			font-size: 8pt;
			}
	...
	<body>
        ...
        <div class="mainDiv clearfix">
          ...
          <div id="contentform">
            ...
            <form lang="en" name="consultation-form" action="/contact/confirmation.jsp" onsubmit="return validateForm(this)" method="post">
          ...
          <div id="contact-box" lang="en" class="clearfix">
            <div class="cbox-left">
            	<a id="book-now-button" onclick="document.getElementById('contentform').style.display='block'; return false;" href="/contact/">
            	<img id="bookbutton" src="book_consultation.png" style="cursor:pointer;" />
              </a>
            </div>
            <div class="cbox-middle">
            	<a id="nesletter-link" href="/reports_analysis/"><img src="newsletter.png" /></a>
            </div>
          ...
          <div id="contact-box1" lang="en">
              <div class="cbox-left"><img id="bookbutton" src="book_consultation.png" style="cursor:pointer;" onclick="showBookform()" /></div>
              <div class="cbox-middle"><img src="newsletter.png" /></div>
              <div class="cbox-right">
